...
import Domain.Statements.HeapStatements.HeapWrittingStmt;
...
public class AppMain {
    ...
    public static List<Command> getCommands() {
        ...
        IStmt ex8 = new CompStmt(new AssignStmt("v", new ConstExp(10)), new CompStmt(
                ...
                new CompStmt(new HeapWrittingStmt("a", new ConstExp(30)), new CompStmt(new PrintStmt(new VarExp("a")), new PrintStmt(new HeapReadingExp("a")))))));
        ...
        IStmt ex9 = new CompStmt(new AssignStmt("v", new ConstExp(10)), new CompStmt(new HeapAllocationStmt("v", new ConstExp(20)),
                new CompStmt(new HeapAllocationStmt("a", new ConstExp(22)), new CompStmt(new HeapWrittingStmt("a", new ConstExp(30)),
        ...
        IStmt ex11 = new CompStmt(new CompStmt(new CompStmt(new AssignStmt("v", new ConstExp(10)), new HeapAllocationStmt("v", new ConstExp(20))),
                new CompStmt(new HeapAllocationStmt("a", new ConstExp(22)), new HeapWrittingStmt("a", new ConstExp(30)))), new CompStmt(new CompStmt(new PrintStmt(new VarExp("a")),
        ...
        IStmt ex12 = new CompStmt(new AssignStmt("v", new ConstExp(10)),
                new CompStmt(new HeapAllocationStmt("a", new ConstExp(22)),
                        new CompStmt(new ForkStmt(new CompStmt(new HeapWrittingStmt("a", new ConstExp(30)),
